  ...
  return (
    <MediumSurface density="focus" interaction="stir" className={cn("min-h-72 p-6", className)} {...props}>
      <div className="flex h-full min-h-60 flex-col">
        <span className="text-[9px] font-medium tracking-[.14em] text-white/45">{eyebrow}</span>
        <div className="my-auto py-8">
          ...
          {children ? <div className="mt-2 text-xs leading-relaxed text-white/50">{children}</div> : null}
        </div>
